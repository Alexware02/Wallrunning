...
public class PlayerController : MonoBehaviour
{
    ...
    void WallrunningMovement() // WALLRUNNING PART WALLRUNNING PART WALLRUNNING PART WALLRUNNING PART WALLRUNNING PART
    {
        Vector3 input = playerInput.input;
    ...
    void GrabbedLedgeMovement()
    {
        ...
        movement.Move(Vector3.zero, 0f, 0f);
    }
    ...
    void CheckForVault()
    {
        ...
        checkDis += (movement.controller.velocity.magnitude / 16f); 
